...
func Color(colors []color.Color) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"frame--colors\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		for _, color := range colors {
			r, g, b, _ := color.RGBA()
			colorStyle := fmt.Sprintf("background-color: rgba(%v,%d,%d,1)", r>>8, g>>8, b>>8)
			templ_7745c5c3_Err = templ.Raw(fmt.Sprintf(`<div class="frame--color" style="%s"></div>`, colorStyle)).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
...
func ImageFitCover(ImageData, imageFit string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_image.templ`, Line: 26, Col: 17}
		}
...
func ImageFitNone(ImageData, imageFit string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var5, templ_7745c5c3_Err = templ.JoinStringErrs(ImageData)
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_image.templ`, Line: 33, Col: 17}
		}
...
func ImageFitContain(ImageData, imageFit string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var7, templ_7745c5c3_Err = templ.JoinStringErrs(ImageData)
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_image.templ`, Line: 41, Col: 17}
		}
...
func layoutSingleView(viewData ViewData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		var templ_7745c5c3_Var9 = []any{"frame", templ.KV("frame-black-bg", !viewData.BackgroundBlur)}
		...
		if viewData.BackgroundBlur && !strings.EqualFold(viewData.ImageFit, "cover") {
			...
			templ_7745c5c3_Var11, templ_7745c5c3_Err = templ.JoinStringErrs(viewData.Images[0].ImageBlurData)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_image.templ`, Line: 128, Col: 47}
			}
		...
		var templ_7745c5c3_Var12 = []any{"frame--image", templ.KV("frame--image-zoom", viewData.ImageZoom), animationDuration(viewData.Refresh), zoomInOrOut()}
		...
		if !viewData.DisableUi {
			var templ_7745c5c3_Var14 = []any{"image--metadata", fmt.Sprintf("image--metadata--theme-%s", viewData.Theme)}
			...
			if viewData.ShowImageDate || viewData.ShowImageTime {
				...
				templ_7745c5c3_Var16, templ_7745c5c3_Err = templ.JoinStringErrs(ImageDateTime(viewData, 0))
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_image.templ`, Line: 149, Col: 34}
				}
			...
			if viewData.ShowMake {
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"image--metadata--exif\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				var templ_7745c5c3_Var17 string
				templ_7745c5c3_Var17, templ_7745c5c3_Err = templ.JoinStringErrs(viewData.Images[0].ImmichImage.ExifInfo.Make)
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_image.templ`, Line: 160, Col: 70}
				}
				...
				templ_7745c5c3_Var18, templ_7745c5c3_Err = templ.JoinStringErrs(viewData.Images[0].ImmichImage.ExifInfo.Model)
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_image.templ`, Line: 160, Col: 120}
				}
...
func layoutSplitView(viewData ViewData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		var templ_7745c5c3_Var20 = []any{"frame", templ.KV("frame-black-bg", !viewData.BackgroundBlur)}
		...
		for imageIndex, imageData := range viewData.Images {
			...
			if viewData.BackgroundBlur && !strings.EqualFold(viewData.ImageFit, "cover") {
				...
				templ_7745c5c3_Var22, templ_7745c5c3_Err = templ.JoinStringErrs(imageData.ImageBlurData)
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_image.templ`, Line: 180, Col: 40}
				}
			...
			var templ_7745c5c3_Var23 = []any{"frame--image", templ.KV("frame--image-zoom", viewData.ImageZoom), animationDuration(viewData.Refresh), zoomInOrOut()}
			...
			if !viewData.DisableUi {
				var templ_7745c5c3_Var25 = []any{"image--metadata", fmt.Sprintf("image--metadata--theme-%s", viewData.Theme)}
				...
				if viewData.ShowImageDate || viewData.ShowImageTime {
					...
					templ_7745c5c3_Var27, templ_7745c5c3_Err = templ.JoinStringErrs(ImageDateTime(viewData, imageIndex))
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_image.templ`, Line: 201, Col: 45}
					}
...
func Image(viewData ViewData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, historyEntry := range viewData.History {
			...
			templ_7745c5c3_Var31, templ_7745c5c3_Err = templ.JoinStringErrs(historyEntry)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_image.templ`, Line: 235, Col: 88}
			}
		...
		for _, newHistoryEntry := range viewData.Images {
			...
			templ_7745c5c3_Var32, templ_7745c5c3_Err = templ.JoinStringErrs(newHistoryEntry.ImmichImage.ID)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_image.templ`, Line: 238, Col: 106}
			}
