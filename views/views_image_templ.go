...
func ImageFitCover(ImageData, imageFit string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_image.templ`, Line: 28, Col: 17}
		}
...
func ImageFitNone(ImageData, imageFit string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_image.templ`, Line: 35, Col: 17}
		}
...
func ImageFitContain(ImageData, imageFit string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_image.templ`, Line: 43, Col: 17}
		}
...
func imageMetadata(viewData ViewData, imageIndex int) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		var templ_7745c5c3_Var9 = []any{"image--metadata", fmt.Sprintf("image--metadata--theme-%s", viewData.Theme)}
		...
		if viewData.ShowImageDate || viewData.ShowImageTime {
			...
			templ_7745c5c3_Var11, templ_7745c5c3_Err = templ.JoinStringErrs(ImageDateTime(viewData, imageIndex))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_image.templ`, Line: 130, Col: 41}
			}
		...
		if viewData.ShowMake {
			...
			templ_7745c5c3_Var12, templ_7745c5c3_Err = templ.JoinStringErrs(cases.Title(language.English, cases.Compact).String(viewData.Images[imageIndex].ImmichImage.ExifInfo.Make))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_image.templ`, Line: 145, Col: 124}
			}
			...
			templ_7745c5c3_Var13, templ_7745c5c3_Err = templ.JoinStringErrs(viewData.Images[imageIndex].ImmichImage.ExifInfo.Model)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_image.templ`, Line: 145, Col: 183}
			}
		...
		if viewData.ShowImageID {
			...
			templ_7745c5c3_Var14, templ_7745c5c3_Err = templ.JoinStringErrs(viewData.Images[imageIndex].ImmichImage.ID)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_image.templ`, Line: 150, Col: 48}
			}
...
func layoutSingleView(viewData ViewData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		var templ_7745c5c3_Var16 = []any{"frame", templ.KV("frame-black-bg", !viewData.BackgroundBlur)}
		...
		if viewData.BackgroundBlur && !strings.EqualFold(viewData.ImageFit, "cover") && len(viewData.Images[0].ImageBlurData) > 0 {
			...
			templ_7745c5c3_Var18, templ_7745c5c3_Err = templ.JoinStringErrs(viewData.Images[0].ImageBlurData)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_image.templ`, Line: 160, Col: 47}
			}
		...
		var templ_7745c5c3_Var19 = []any{"frame--image", templ.KV("frame--image-zoom", viewData.ImageZoom), animationDuration(viewData.Refresh), zoomInOrOut()}
...
func layoutSplitView(viewData ViewData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		var templ_7745c5c3_Var22 = []any{"frame", templ.KV("frame-black-bg", !viewData.BackgroundBlur)}
		...
		for imageIndex, imageData := range viewData.Images {
			var templ_7745c5c3_Var24 = []any{fmt.Sprintf("frame--layout-%s", viewData.Layout)}
			...
			if viewData.BackgroundBlur && !strings.EqualFold(viewData.ImageFit, "cover") && len(imageData.ImageBlurData) > 0 {
				...
				templ_7745c5c3_Var26, templ_7745c5c3_Err = templ.JoinStringErrs(imageData.ImageBlurData)
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_image.templ`, Line: 191, Col: 40}
				}
			...
			var templ_7745c5c3_Var27 = []any{"frame--image", templ.KV("frame--image-zoom", viewData.ImageZoom), animationDuration(viewData.Refresh), zoomInOrOut()}
...
func Image(viewData ViewData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, historyEntry := range viewData.History {
			...
			templ_7745c5c3_Var30, templ_7745c5c3_Err = templ.JoinStringErrs(historyEntry)
			if templ_7745c5c3_Err != nil {
		...
		for _, newHistoryEntry := range viewData.Images {
			...
			templ_7745c5c3_Var31, templ_7745c5c3_Err = templ.JoinStringErrs(newHistoryEntry.ImmichImage.ID)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/views_image.templ`, Line: 228, Col: 106}
			}
